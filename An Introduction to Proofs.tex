...
\end{problem}
\begin{definition}
    Let $(X,\le)$ be a partially ordered set. The set is \hdef{well-ordered} if for every nonempty subset $S$ of $X$, there exists $a\in S$ such that for all $s\in S$, $a\le s$. For $a,b\in X$ with $a\ge b$ and $a\ne b$, then we write the strict ordering as $a>b$.
\end{definition}
