...
\end{definition}
\begin{remark}
    For any category $\cft{C}$, the collections $\Ob(\cft{C})$ and ${\Hom}_{\cft{C}}(X,Y)$ are not guaranteed to be sets. However, we will use $\in$ for the collections for clarity.
\end{remark}
\par
