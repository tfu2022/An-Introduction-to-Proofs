...
\begin{definition}
    ...
    \begin{enumerate}
        ...
        \item for each pair of objects $X$ and $Y$, there exists a collection of \hdef{morphisms} $f:X\to Y$, where $X$ is called the \hdef{domain} and $Y$ is called the \hdef{codomian};
