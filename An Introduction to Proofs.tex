...
\end{definition}
\begin{problem}
    Prove that the recursion theorem guarantees the addition on $\N$ is well-defined.
\end{problem}
\begin{problem}
    Prove that for all $n\in\N$, $n+0=n$.
\end{problem}
\begin{proposition}
    For all $m,n\in\N$, prove that $m+n=n+m$.
\end{proposition}
\begin{proof}
    
\end{proof}
\begin{problem}
    For all $a,b,c\in\N$, prove that $a+(b+c)=(a+b)+c$.
\end{problem}
