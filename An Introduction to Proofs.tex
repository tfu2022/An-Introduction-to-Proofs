...
\end{problem}
\begin{definition}
    An ordinal $\al$ is said to be a \hdef{limit ordinal} if 
\end{definition}
\begin{proposition}
    Every ordinal is either $\es$, a successor ordinal, or a limit ordinal.
\end{proposition}
