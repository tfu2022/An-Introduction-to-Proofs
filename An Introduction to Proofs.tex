...
\end{problem}
\begin{proposition}
    Two different ordinals do not have the same order-type.
\end{proposition}
\begin{proof}
    Let $\al$ and $\be$ be ordinals such that $\al\ne\be$. Let $f:\al\to\be$ be order-preserving. Suppose $f$ is bijective. 
