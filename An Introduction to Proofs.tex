...
\par
Many people have contributed to this note. Special thanks to Fung San Gaan, who wrote the real analysis part of this note and collaborate with me on section 10. I shall also thank to Tingyu Wu. She wrote the linear algebra part and collaborate with me on section 4.
\par
...
\end{proof}
\par
Finally, we present the Cantor-Schröder-Bernstein theorem. This proof is technical, you may skip it and remember the result.
...
We tried to include many results in different area. However, this is just a short note, if you are interested in a certain area, we recommend some textbooks as supplementary sources.
\par
All axioms in ZFC have been shown in the note except the axiom of regularity. This axiom is essential to 

Our treatments on sets largely follows from \textit{Set Theory} by Thomas Jech. You might notice that our discussions on sets lack the . Notice that this entire note is based on ZFC, but ZFC has its weaknesses. 
