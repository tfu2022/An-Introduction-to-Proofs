...
\addbibresource{An Introduction to Proofs.bib}
\begin{document}
\hsetup
\htoc
\hmain
...
% \customtheorem{Axiom of choice}\begin{Axiom of choice}\index{axiom of choice} Let $F$ be a function defined on a set $I$ such that $F(i)$ is a nonempty set for all $i\in I$. Then there exists a \hdef{choice function} $d$ defined on $I$ such that $f(i)\in F(i)$ for all $i\in I$. \end{Axiom of choice}
