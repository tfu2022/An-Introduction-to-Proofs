...
\par
Our treatments on sets largely follows from \textit{Set Theory} by Thomas Jech. You might notice that the discussions on sets only explain what the axiom tells. 

Moreover, notice that this entire note is based on ZFC, but ZFC has its weaknesses. There are different systems of set theory, 
