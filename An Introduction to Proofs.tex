...
\end{definition}
\begin{remark}
    For any category $\cft{C}$, the collections $\Ob(\cft{C})$ and ${\Hom}_{\cft{C}}(X,Y)$ are not guaranteed to be sets. We will still use $\in$ in collections. It is informal but clear.
\end{remark}
\par
